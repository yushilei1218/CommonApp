...
public class DropManager {
    ...
    static final int TEXT_SIZE = ScreenUtil.sp2px(10); // 10sp

    static final int CIRCLE_RADIUS = ScreenUtil.dip2px(8); // 8dip
    ...
    private int statusBarHeight = 0; // 状态栏(通知栏)高度
...
//        this.statusBarHeight = ScreenUtil.getStatusBarHeight(context);
    ...
    public Paint getCirclePaint() {
        if (circlePaint == null) {
            ...
            circlePaint.setColor(Color.rgb(255, 87, 90));
